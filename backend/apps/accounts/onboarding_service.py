...
assistant_reply трябва да е кратък, ясен и естествен: обикновено 1 или 2 кратки изречения.
Ако липсва нещо важно, задай само един конкретен въпрос.
Не добавяй излишни съвети или обяснения.
Върни само JSON.
"""
        user_prompt = f"""
