...
class AuditEventType(models.TextChoices):
    ...
    USER_INPUT_REQUESTED = "user_input_requested", "User Input Requested"
    USER_INPUT_RECEIVED = "user_input_received", "User Input Received"
    USER_INPUT_RESOLVED = "user_input_resolved", "User Input Resolved"
    USER_INPUT_FALLBACK = "user_input_fallback", "User Input Fallback"
