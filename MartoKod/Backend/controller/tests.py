...
class SemiAgentServiceTests(SimpleTestCase):
    ...
    def test_run_caps_each_board_pipeline_stage_to_256_tokens(self) -> None:
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(len(qwen_client.calls), 3)
            ...
            self.assertEqual(qwen_client.calls[2]["generation_overrides"]["max_new_tokens"], 256)
            ...
            self.assertNotIn("json_continuation_budget", qwen_client.calls[2]["generation_overrides"])
