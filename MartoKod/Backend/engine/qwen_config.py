...
@dataclass
class QwenConfig:
    model_id: str = os.getenv("QWEN_MODEL_ID", "Qwen/Qwen3-4B-Instruct-2507")
    device_map: str = os.getenv("QWEN_DEVICE_MAP", "auto")
    max_new_tokens: int = int(os.getenv("QWEN_MAX_NEW_TOKENS", "1536"))
    json_continuation_budget: int = int(os.getenv("QWEN_JSON_CONTINUATION_BUDGET", "384"))
    json_continuation_chunk: int = int(os.getenv("QWEN_JSON_CONTINUATION_CHUNK", "128"))
    ...
    load_in_4bit: bool = env_flag("QWEN_LOAD_IN_4BIT", True)
    ...
    attn_implementation: str = os.getenv("QWEN_ATTN_IMPL", "sdpa")
