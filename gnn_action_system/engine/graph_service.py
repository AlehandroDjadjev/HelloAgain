...
from .prompts import build_action_inventory_text, build_parser_system_prompt, render_attribute_inventory
...
class GraphService:
    ...
    def _plan(self, mode: str, prompt: str) -> Dict[str, Any]:
        ...
        system_prompt = build_parser_system_prompt(mode, attr_text, action_text)
        plan = self.parser.parse(mode=mode, system_prompt=system_prompt, user_prompt=prompt)
